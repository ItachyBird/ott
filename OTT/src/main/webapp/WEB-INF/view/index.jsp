...
<body>
    <div class="container">
        ...
        <div class="movie-list-container" style="margin-top: -100px;">
            <h1 class="movie-list-title">Top 70</h1>
    <%
...
try {
    ...
    while (rs.next()) {
        if (count % 3 == 0) { // Start a new row for every third poster
...
%>
&movieId=<%= movie_id %>" class="movie-list-item">
...
<%
        count++;
        if (count % 3 == 0) { // Close the row after displaying three posters
            out.println("</div>");
            out.println("</div>");
        }
    }
